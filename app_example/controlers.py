...
class APIClass:
	...
	async def create_author(
		...
		return service.author_create(data)
	...
	async def update_author(
		...
		service = AuthorService(self.db)
		return service.author_update(id_author, data)
	...
	async def delete_author(
							...
							id_author: int):
		service = AuthorService(self.db)
		return service.author_delete(id_author)
	...
	async def get_author(
							...
							id_author: int):
		service = AuthorService(self.db)
		return service.author_retrieve(id_author)
	...
	async def list_author(
		...
		service = AuthorService(self.db)
		return service.author_list(filter)
